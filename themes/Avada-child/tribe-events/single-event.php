...
<div id="tribe-events-content" class="tribe-events-single vevent hentry">
	...
	<?php while ( have_posts() ) :  the_post(); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	     <!-- Not a real form -->
      <div style="clear:both;"><a href="https://clients.mindbodyonline.com/classic/home?studioid=38100&classDate=<?php print_r($start_date); ?>&view=day" target="_blank"><input type="button" id="sign_up" value="Sign Up" style=" background-color:#C6CED9; font-size:1.3em; padding:6px 20px; margin: 0 0 6px"></a></div>
			...
			<!-- Event content -->
			<!-- NOT REAL.  JUST FOR DEMO -->
      <div><a href="/classes-workshops_calendar" style="color:#444;font-size:.8em"> &lt;- Back to Calendar </a></div>
